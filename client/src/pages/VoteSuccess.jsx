    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="w-full bg-white border-b border-gray-100 shadow-sm px-4 md:px-8 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              src="/logo.png"
              alt="KETE-KRACHIE NURSING & MIDWIFERY"
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-lg text-center">
          ...
          {/* Success message */}
          <h1
            className="text-[#0a6b1b] text-4xl md:text-5xl font-black uppercase mb-4"
          ...
          <p className="text-gray-500 text-lg mb-8 leading-relaxed">
            ...
            participating in the KETE-KRACHIE NURSING & MIDWIFERY Student
            Elections.
          </p>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 px-5 py-4 text-left mb-8">
            ...
            <p className="text-blue-700 text-xs leading-relaxed">
              Results will be announced once the voting period closes. You will
              be notified via your school email and notice boards.
            </p>
          </div>
      ...
      <footer className="bg-white border-t border-gray-100 py-4 px-6">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
          <p className="text-gray-300 text-[10px] uppercase tracking-widest">
            © 2026 KETE-KRACHIE NURSING & MIDWIFERY · Student Elections
          </p>
          <p className="text-gray-400 text-xs">
            Powered by{" "}
            <span className="font-bold text-[#0a6b1b]">
              KETE-KRACHIE Electoral Commission
            </span>
          </p>
        </div>
      </footer>
